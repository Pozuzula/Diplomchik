...
label lekciy:
    ...
    "Меня зовут Стряпунина Нэли Ильинична, я преподователь 1С"
    if  les == 0:
        "Вижу ты тут первый раз."
        "Сейчас я быстро введу тебя в курс дела."
        "Здесь мы изучаем 1С!"
        "Если хочешь можешь послушать лекцию и попробовать сдать тест!"
        
        menu lec_menu:

            "Уйти":
                "Если передумаешь приходи к нам!"
                jump kab_pyt

            "Послушать лекцию и сдать тест":
