...
define config.name = _("МУИВ: СЖСГ")
...
define gui.about = _p(""" Игра была разработана в рамках выполнения выпускной квалификационной работы студенткой Московского Университета имени Витте. Выполянла работу Зубкова Полина
""")
...
define config.save_directory = "Diplom-1708009966"
